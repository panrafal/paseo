...
import { takePendingComposerReferences } from "../webview/webview-registry";
import {
  ...
  async dispatch(command: string, args: unknown): Promise<unknown> {
    switch (command) {
      ...
      case "close_local_daemon_transport":
        ...
        return null;
      case "composer.takePendingReferences":
        // "Send to Paseo" fired before this app had mounted; hand over what was queued.
        return takePendingComposerReferences();
