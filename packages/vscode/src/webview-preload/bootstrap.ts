...
import { installFileDragGuard } from "./file-drag";
...
// See file-drag.ts: this has to register before VS Code's webview preamble does, which the
// bootstrap's injection point ahead of the app bundle guarantees.
installFileDragGuard(window);
